          ...
          <div className="Day-box">
            ...
            <div className="Day-leftLineAreaSmall">
              ...
              <div className="Day-textArea">
                ...
                <h6 className="Day-backSchedule2">Arashiyama</h6>
              </div>
            </div>
          </div>
          ...
          <div className="Day-box">
            ...
            <div className="Day-leftLineAreaSmall">
              ...
              <div className="Day-textArea">
                ...
                <h6 className="Day-backSchedule2">Maruyama Park</h6>
              </div>
            </div>
          </div>
          <div className="Day-box-picture">
          ...
          <div className="Day-box">
            ...
            <div className="Day-busArea">
              ...
              <div className="Day-leftLineArea">
                <div className="Day-leftLine"></div>
                <div className="Day-textArea">
                  <p className="Day-backSchedule">清水駐車場</p>
                  <h6 className="Day-backSchedule2">Kiyomizu Parking</h6>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="Day-box">
            ...
            <div className="Day-leftLineAreaSmall">
              ...
              <div className="Day-textArea">
                ...
                <h6 className="Day-backSchedule2">Kitano Tennmannguu</h6>
              </div>
            </div>
          </div>
          <div className="Day-box-picture">
          ...
          <div className="Day-box">
            ...
            <div className="Day-busArea">
              <div className="Day-leftLineArea2">
                ...
                <div className="Day-textArea">
                  <p className="Day-backSchedule">北野天満宮</p>
                  <h6 className="Day-backSchedule2">Kitano Tenmangu</h6>
                </div>
              </div>
            </div>
            ...
            <div className="Day-leftLineAreaSmall2">
              ...
              <div>
                ...
                <h6 className="Day-backSchedule2">Nishiki Ichiba</h6>
              </div>
            </div>
          </div>
          ...
          <div className="Day-box">
            ...
            <div className="Day-busArea">
              ...
              <div className="Day-leftLineArea">
                ...
                <div className="Day-textArea">
                  <p className="Day-backSchedule">錦市場</p>
                  <h6 className="Day-backSchedule2">Nishiki Itiba</h6>
                </div>
              </div>
            </div>
          </div>
