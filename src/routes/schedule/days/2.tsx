      ...
      <div className="Day-box">
        ...
        <div className="Day-busArea">
          <div className="Day-leftLineArea2">
            ...
            <div className="Day-textArea">
              <p className="Day-backScheduleSmall">ヒルトン広島</p>
              <h6 className="Day-backSchedule2">Hilton Hiroshima</h6>
            </div>
          </div>
        </div>
        ...
        <div className="Day-leftLineAreaSmall2">
          ...
          <div>
            ...
            <h6 className="Day-backSchedule2Small">Kurashiki bikanChiku</h6>
          </div>
        </div>
      </div>
      ...
      <div className="Day-box">
        ...
        <div className="Day-busArea">
          <div className="Day-leftLineArea2">
            ...
            <div className="Day-textArea">
              <p className="Day-backScheduleSmall">倉敷美観地区</p>
              <h6 className="Day-backSchedule2">Kurashiki Bikanchiku</h6>
            </div>
          </div>
        </div>
        <img className="Day-triangle4" src={triangle}></img>
      ...
      <div className="Day-box">
        ...
        <div className="Day-leftLineArea2">
          ...
          <div>
            ...
            <h6 className="Day-backSchedule2">SeaSide Hotel Maiko Villa</h6>
          </div>
        </div>
      </div>
